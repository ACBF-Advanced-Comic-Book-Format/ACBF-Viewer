                    ...
                    PWSTR lpCmdLine, int nCmdShow)
{
    ...
    launch_code = "import sys; from %s import %s; sys.exit()" % (
        module, func)
...
def main():
    ...
    company_name = "Advanced Comic Book Format"
    misc = os.path.dirname(os.path.realpath(__file__))

    build_launcher(
        os.path.join(target, "acbfv.exe"),
        os.path.join(misc, "acbfv.ico"), "ACBF Viewer", "ACBF Viewer",
        version, company_name, "share.acbfv.src:acbfv", True)
