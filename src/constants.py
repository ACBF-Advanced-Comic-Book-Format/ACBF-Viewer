...
# set icons directory
ICON_PATH = ''
if os.path.isfile(os.path.join(BASE_DIR, 'images/acbfv.png')):
  ICON_PATH = os.path.join(BASE_DIR, 'images')
elif os.path.isfile(os.path.join(os.path.dirname(exec_path), 'images/acbfv.png')):
  ICON_PATH = os.path.join(os.path.dirname(exec_path), 'images')
elif os.path.isfile(os.path.join(os.path.dirname(os.path.realpath(__file__)), '../images/acbfv.png')):
  ...
  for prefix in ['/usr', '/usr/local', '/usr/X11R6']:
    if os.path.isfile(os.path.join(prefix, 'share/acbfv/images/acbfv.png')):
